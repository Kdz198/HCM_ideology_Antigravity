...
const resultsData = {
  ...
  B: {
    ...
    description: "Bạn tò mò với thế giới, đam mê học hỏi ngôn ngữ, văn hóa mới và không bao giờ tự giới hạn góc nhìn của mình. Bạn có tinh thần cởi mở, tôn trọng sự khác biệt và luôn khao khát hội nhập để hoàn thiện bản thân.",
    historyTitle: "Người bồi bàn tự học vĩ đại",
    historyStory: "Năm 1911, chàng thanh niên Nguyễn Tất Thành bước chân xuống con tàu Đô đốc Latouche-Tréville với hai bàn tay trắng. Để sinh tồn và nghiên cứu thế giới, Người đã làm đủ mọi nghề: phụ bếp trên tàu, cào tuyết ở London, thợ rửa ảnh ở Paris.\n\nỞ mỗi quốc gia đi qua, việc đầu tiên của Người là tự học ngôn ngữ bản địa. Người viết từ mới lên cánh tay để vừa làm việc vừa nhẩm thuộc lòng. Nhờ tư duy cởi mở đó, Người không chỉ thấu hiểu văn hóa phương Đông mà còn tinh thông triết học phương Tây, đọc viết thành thạo tiếng Pháp, Anh, Hoa, Nga... trở thành một biểu tượng của sự giao thoa văn hóa toàn cầu.",
  ...
  D: {
    ...
    description: "Bạn nhạy cảm với cái đẹp, yêu thiên nhiên, thích tìm kiếm sự bình yên trong tâm hồn và có xu hướng sống chữa lành (healing). Bạn trân trọng môi trường, yêu thích nghệ thuật và mong muốn tạo dựng một lối sống hài hòa, bền vững.",
    historyTitle: "Thi sĩ của thiên nhiên và những buổi chiều bên bờ suối",
    historyStory: "Dù là một nhà chính trị bận rộn với vận mệnh quốc gia, Hồ Chí Minh luôn giữ cho mình một khoảng không gian nghệ thuật thuần khiết. Giai đoạn ở chiến khu Việt Bắc, Người sống gắn bó với núi rừng: \"Sáng ra bờ suối, tối vào hang / Cháo bẹ rau măng vẫn sẵn sàng\".\n\nKhi về Hà Nội, Người tự tay chăm sóc vườn cây vú sữa, cho cá ăn mỗi buổi chiều sau giờ làm việc. Tình yêu thiên nhiên của Người không chỉ dừng lại ở việc thưởng ngoạn, mà đã nâng tầm thành một triết lý hành động với phong phong trào \"Tết trồng cây\" — một tư duy bền vững về môi trường (Eco-lifestyle) đi trước thời đại cả nửa thế kỷ.",
  ...
  return (
    <div className="bg-background text-on-background font-body-md paper-texture min-h-screen flex flex-col">
      ...
      <main className="flex-grow pt-32 pb-xl px-gutter max-w-container-max mx-auto w-full">
        {!started && (
          <header className="text-center max-w-3xl mx-auto mb-xl mt-6">
            <span className="text-primary font-label-md text-label-md tracking-[0.2em] uppercase mb-sm block">Khám phá bản thân</span>
            <h1 className="font-display-lg text-display-lg text-primary mb-md font-serif leading-tight">
            ...
            <p className="font-body-lg text-body-lg text-secondary mb-lg leading-relaxed">
              Mỗi lựa chọn và thói quen nhỏ trong cuộc sống hiện đại đều mang trong mình những giá trị văn hóa và tư duy độc bản. Hãy cùng trả lời 10 câu hỏi trắc nghiệm tâm lý thú vị này để khám phá xem triết lý sống của bạn gặp gỡ câu chuyện lịch sử nào của Chủ tịch Hồ Chí Minh.
            </p>
            <button onClick={startQuiz} className="inline-flex items-center gap-sm bg-primary text-on-primary px-xl py-md rounded-lg font-label-md text-label-md hover:bg-primary-container transition-all group shadow-md hover:shadow-lg cursor-pointer">
              BẮT ĐẦU TRẮC NGHIỆM
        ...
        {started && !finished && (
          <section className="max-w-2xl mx-auto animate-bloom mt-4">
            ...
            <div className="mb-lg">
              <div className="flex justify-between items-end mb-sm">
                <div className="flex items-center gap-sm">
                  {currentStep > 0 && (
                    <button onClick={handleBack} className="text-primary hover:text-primary-container flex items-center gap-xs font-label-md text-xs cursor-pointer">
                      <span className="material-symbols-outlined text-sm">arrow_back</span> Quay lại
                    </button>
                  )}
                  <span className="font-label-md text-label-sm text-primary font-bold">Câu hỏi {currentStep + 1} / {quizData.length}</span>
                </div>
            ...
            {/* Question Card */}
            <div className={`bg-surface border border-outline-variant/50 p-lg rounded-xl relative overflow-hidden transition-all duration-300 shadow-md ${animating ? 'opacity-0 translate-y-4' : 'opacity-100 translate-y-0'}`}>
              ...
              <div className="relative z-10 space-y-lg">
                <h2 className="font-headline-md text-headline-md text-on-surface font-serif leading-snug">{question.q}</h2>
                <div className="space-y-md">
                  {question.options.map((opt, i) => (
                    ...
                    >
                      <span className="font-body-md text-body-md text-on-surface-variant group-hover:text-primary transition-colors pr-md">{opt}</span>
                      <span className="material-symbols-outlined opacity-0 group-hover:opacity-100 text-primary transition-opacity shrink-0">check_circle</span>
                    </button>
                  ))}
                </div>
              </div>
        ...
        {finished && (
          <section className="max-w-4xl mx-auto animate-bloom mt-4">
            <div className="bg-surface border border-outline-variant/50 p-md md:p-xl rounded-2xl shadow-xl overflow-hidden relative">
                ...
                <div className="lg:col-span-5 space-y-md">
                  <div className="relative rounded-xl overflow-hidden aspect-[4/5] bg-surface-variant border border-outline-variant/30 shadow-md">
                    ...
                    <div className="absolute bottom-0 left-0 p-md md:p-lg w-full text-white">
                      <span className="text-xs uppercase tracking-widest text-on-primary-container bg-primary-container px-2 py-1 rounded font-bold">{result.modernStyle}</span>
                ...
                <div className="lg:col-span-7 space-y-lg flex flex-col justify-between">
                  <div className="space-y-md">
                    <div className="border-b border-outline-variant/30 pb-sm">
                      <span className="text-tertiary font-label-md text-label-md tracking-widest uppercase block mb-xs">Kết quả trắc nghiệm</span>
                      <h2 className="font-headline-lg text-headline-lg text-primary leading-tight">Bạn là: {result.tag}</h2>
                    </div>
                  ...
                  <div className="pt-md flex flex-wrap gap-md border-t border-outline-variant/30 mt-lg">
                    <button onClick={startQuiz} className="bg-primary text-on-primary px-xl py-md font-label-md text-label-md rounded-lg flex items-center gap-sm hover:bg-primary-container transition-all shadow-md cursor-pointer">
                      <span className="material-symbols-outlined">refresh</span> Làm lại trắc nghiệm
                    </button>
                    <Link to="/notebook" className="border border-primary text-primary px-xl py-md font-label-md text-label-md rounded-lg flex items-center gap-sm hover:bg-primary/5 transition-all">
      ...
      <footer className="bg-secondary-container py-xl mt-xl border-t border-outline-variant/20">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-lg max-w-container-max mx-auto px-gutter">
          ...
          <div className="flex flex-col gap-sm">
            <Link className="font-caption text-caption text-on-secondary-container/80 hover:text-primary underline underline-offset-4 transition-all" to="/">Về dự án</Link>
            <Link className="font-caption text-caption text-on-secondary-container/80 hover:text-primary underline underline-offset-4 transition-all" to="/">Chính sách bảo mật</Link>
          </div>
